...
itemTable weaponTable[NUMBER_WEAPON_KINDS] = {
    ...
    {"broadsword",          "", "", 10, 990,        19, 0, {14, 22, 1},    true, false, 0, false, "This towering blade inflicts heavy damage by investing its heft into every cut. Its great mass blunts the benefit of enchantment, however: beyond a certain charge, each further enchantment adds far less than it would to a lighter weapon."},
    ...
    {"war axe",             "", "", 10, 990,        19, 0, {12, 17, 1},    true, false, 0, false, "The enormous steel head of this war axe puts considerable heft behind each stroke. The arc of its swing permits you to attack all adjacent enemies simultaneously. Its great mass blunts the benefit of enchantment, however: beyond a certain charge, each further enchantment adds far less than it would to a lighter weapon."},
