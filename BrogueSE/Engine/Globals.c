...
itemTable ringTable[NUMBER_RING_KINDS] = {
    {"clairvoyance",    itemGems[0], "",    1,  900,    0, 0, {1,3,1}, false, false, 1, false, "This ring of eldritch scrying will permit you to see through nearby walls and doors, within a radius determined by the level of the ring. On arriving at a new depth, its scrying also reveals the benevolent or malevolent aura of magic items lying anywhere on the floor -- even in undiscovered rooms, several at once for the most powerful rings. A cursed ring of clairvoyance will blind you to your immediate surroundings and cloud this scrying."},
