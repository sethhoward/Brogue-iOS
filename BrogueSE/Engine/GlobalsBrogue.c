...
itemTable potionTable_Brogue[] = {
    ...
    {"empty bottle",        itemColors[5], "",  15, 500,    0, 0, {0,0,0}, false, false, 1,  false, "An ordinary glass flask, stoppered and empty. While you carry it, each gas, liquid, or hazard you can reach fills it with a different potion. Step into the ones you can survive on foot; drift over lava or a chasm while levitating to skim those; or set the bottle down and zap it."}, // iOS port (iBrogue): replaces potion of detect magic; v2 capture system
    ...
    {"honey",               itemColors[17], "", 12, 400,    0, 0, {20,20,0}, false, false, 1,  false, "A heavy jar of thick golden honey. Swallowed, its slow sweetness mends the body over time. Dashed against the ground -- by your hand, or by a bolt of lightning or flame -- it spreads into a sticky golden mire that snares whatever is caught in it."},
    {"vomit",               itemColors[18], "", 7, 150,    0, 0, {0,0,0}, false, false, -1, false, "A flask of foul, churning bile. Exposed to the open air it erupts into a reeking cloud that sickens any creature who breathes it, just as a zombie's stench does."},
    {"wort",                itemColors[19], "", 12, 500,    0, 0, {0,0,0}, false, false, 1,  false, "A flask swirling with luminous medicinal spores -- wort. Uncorked or thrown, it bursts into a cloud of healing motes that knit the wounds of any who linger within it."},
    {"venom",               itemColors[20], "", 7, 250,    0, 0, {15,15,0}, false, false, -1, false, "A vial of viscous green venom. Drinking it floods your veins with poison; hurled, it douses whatever it strikes in the same searing toxin."},
...
#define BROGUE_RECORDING_VERSION_STRING "SE " STRINGIFY(BROGUE_MAJOR) "." STRINGIFY(BROGUE_MINOR) "." STRINGIFY(BROGUE_PATCH)
...
*/
#define BROGUE_PATCH_VERSION_PATTERN "SE " STRINGIFY(BROGUE_MAJOR) "." STRINGIFY(BROGUE_MINOR) ".%hu"
...
// iOS port (Brogue SE): SE's content changes dungeon generation vs CE, so SE starts
// its own dungeon-compatibility lineage rather than claiming parity with any CE seed.
#define BROGUE_DUNGEON_VERSION_STRING "SE 1.0"
