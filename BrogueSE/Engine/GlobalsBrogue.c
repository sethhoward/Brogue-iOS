...
itemTable potionTable_Brogue[] = {
    ...
    {"empty bottle",        itemColors[5], "",  0,  500,    0, 0, {0,0,0}, false, false, 1,  false, "An ordinary glass flask, stoppered and empty. While you carry it, each gas, liquid, or hazard you can reach fills it with a different potion. Step into the ones you can survive on foot; drift over lava or a chasm while levitating to skim those; or set the bottle down and zap it."}, // iOS port (Brogue SE): freq 0 -- the empty bottle is NOT in the weighted potion draw; it has its own additive metered pass in populateItems so it never displaces a real potion. See docs/design/empty-bottle-v2.md.
    ...
    {"detect magic",        itemColors[0],  "", 16, 350,    0, 0, {0,0,0}, false, false, 1,  false, "This mysterious brew sensitizes your mind to the radiance of magic, but only fleetingly: it reveals the helpful or harmful nature two items in your pack, chosen at random. Hurled instead, its insight turns outward -- sensing one or two undiscovered magic items elsewhere on this level and marking their auras on your map. Pairing this item with a Ring of Wisdom to make detection stronger."},
