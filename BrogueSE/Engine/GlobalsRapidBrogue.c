...
const meteredItemGenerationTable meteredItemsGenerationTable_RapidBrogue[] = {
    ...
    // iOS port (iBrogue): keep this potion section index-parallel with potionTable_RapidBrogue.
...
itemTable potionTable_RapidBrogue[] = {
    ...
    {"empty bottle",        itemColors[5], "",  0,  500,    0, 0, {0,0,0}, false, false, 1,  false, "An ordinary glass flask, stoppered and empty. While you carry it, each gas, liquid, or hazard you can reach fills it with a different potion -- already known to you. Step into the ones you can survive on foot; drift over lava or a chasm while levitating to skim those; or set the bottle down and zap it with a bolt to catch the bolt itself."}, // iOS port (Brogue SE): freq 0 -- empty bottle has its own additive metered pass in populateItems, not the weighted potion draw. See docs/design/empty-bottle-v2.md.
    ...
    {"hallucination",       itemColors[11], "", 10, 500,    0, 0, {75,75,0}, false, false, -1, false, "This flask contains a vicious and long-lasting hallucinogen. Under its dazzling effect, you will wander through a rainbow wonderland, unable to discern the form of any creatures or items you see. Throwing this potion will create a luminescent fungal forest, which will block line of sight beyond it."},
