...
itemTable potionTable_RapidBrogue[] = {
    ...
    {"empty bottle",        itemColors[5], "",  20, 500,    0, 0, {0,0,0}, false, false, 1,  false, "An ordinary glass flask, stoppered and empty. While you carry it, each gas, liquid, or hazard you can reach fills it with a different potion -- already known to you. Step into the ones you can survive on foot; drift over lava or a chasm while levitating to skim those; or set the bottle down and zap it with a bolt to catch the bolt itself."}, // iOS port (iBrogue): replaces potion of detect magic; v2 capture system
